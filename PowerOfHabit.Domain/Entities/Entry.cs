...
namespace PowerOfHabit.Domain.Entities
{
    public sealed class Entry
    {
        ...
        public Entry(int entryId, DateTime entryDate, double entryAmount, DateTime entryDateRegistration)
        {
        ...
        public Entry(DateTime entryDate, double entryAmount, DateTime entryDateRegistration)
        {
            ValidateDomain(entryDate, entryAmount, entryDateRegistration);

        }
        public void Update(DateTime entryDate, double entryAmount, DateTime entryDateRegistration, int groupId, int userId)
        {
            ValidateDomain(entryDate, entryAmount, entryDateRegistration);
            GroupId = groupId;
            UserId = userId;
        ...
        public void ValidateDomain(DateTime entryDate, double entryAmount, DateTime entryDateRegistration)
        {
